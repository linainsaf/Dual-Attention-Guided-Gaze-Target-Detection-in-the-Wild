#Import of the code from the github ...
import os
import glob
import cv2
import argparse
...
# Import from the libs of the Monocular Depth Estimator

###############################################
#### /!\ Modify from the original code /!\ ####
###############################################
#import transforms.Resize, transforms.NormalizeImage, transforms.PrepareForNet as Resize, #NormalizeImage, PrepareForNet
from Monocular_libs.transforms import Resize, NormalizeImage, PrepareForNet
import Monocular_libs.utils as utils
###############################################
#### /!\ Modify from the original code /!\ ####
###############################################
